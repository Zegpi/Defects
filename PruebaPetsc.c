...
//System for z(0)
  ...
  PetscErrorCode Matrix(PetscReal *K,PetscReal *ind, PetscReal *coords, PetscReal *gauss)
  {
...
int main(int argc,char **args)
{
  ...
  PetscInt       i,j,Ii,J,Istart,Iend,m = 1000,n = 1000,its,bs=1,II,JJ,jj;
  PetscErrorCode ierr;
  PetscScalar    v;
  ...
  ierr = KSPSetTolerances(ksp,1.e-6/((m+1)*(n+1)),1.e-50,PETSC_DEFAULT,PETSC_DEFAULT);CHKERRQ(ierr);
