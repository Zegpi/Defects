...
PruebaV5S_NoPerp_Model1 PruebaV5S_NoPerp_Model2 PruebaV5S_NoPerp_Model3 PruebaV5S_YesPerp_Model1 PruebaV5S_YesPerp_Model2 PruebaV5S_YesPerp_Model3 process_results\
PruebaPetsc\
Prueba1D \
...
process_results: process_results.o chkopts
	$(CLINKER) -o $@ $< $(PETIGA_LIB)
	$(RM) -f $<
...
generateInput_tanh: generateInput_tanh.o chkopts
	$(CLINKER) -o $@ $< $(PETIGA_LIB)
	$(RM) -f $<
