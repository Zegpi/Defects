...
poisson2dmod \
Prueba PruebaV2 PruebaV3 PruebaV4 PruebaV5 PruebaV5-1 PruebaV5-2 PruebaTest PruebaDislCS Elas Eq Energy generateInput generateInput2\
PruebaPetsc\
Prueba1D \
...
PruebaV5-2: PruebaV5-2.o chkopts
	$(CLINKER) -o $@ $< $(PETIGA_LIB)
	$(RM) -f $<
